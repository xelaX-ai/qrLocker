      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-5">
          <div className="relative flex-1">
            ...
            <input type="text" placeholder="Поиск по номеру, имени или отделу..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full pl-9 pr-4 py-2.5 text-sm border border-neutral-200 rounded-xl bg-white placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:border-transparent transition-all" />
          </div>
      ...
      <div onClick={onToggle} className={"cursor-pointer bg-white border-2 rounded-2xl p-5 transition-all duration-150 " + (selected ? "border-neutral-900 bg-neutral-50" : "border-neutral-100 hover:border-neutral-300")}>
        <div className="flex items-start justify-between">
          <div>
            ...
            {locker.department && <span className="ml-2 text-xs px-1.5 py-0.5 bg-neutral-100 text-neutral-500 rounded-md">{locker.department}</span>}
